...
train_data_path= PATH + 'data\\test_public'
output_path= PATH + 'data\\test'
name_zip_file_path = PATH + 'submission_test'

NEW_DATA_MERGED = False
NEW_CLEANED_DF = True

# se a pasta nao existe crie ela 
for path in [submission_path, train_data_path, output_path]:
